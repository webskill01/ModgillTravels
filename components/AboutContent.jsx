      ...
      <div className="max-w-6xl mx-auto px-4 py-8 sm:py-12">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-6">
            {stats.map((stat, index) => (
              ...
              >
                ...
                <div className="text-ink-muted text-xs sm:text-sm">{stat.label}</div>
              </div>
            ))}
          </div>
        </section>
                ...
                >
                  <div className="flex items-start gap-3 sm:gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-ink-muted text-xs sm:text-sm leading-relaxed">{feature.description}</p>
                    </div>
                  </div>
                </div>
              ))}
          ...
          <div className="bg-white rounded-xl sm:rounded-2xl p-5 sm:p-6 border border-line">
            ...
            <div className="grid grid-cols-2 gap-4 sm:gap-6 mb-6">
              <div>
                ...
                <ul className="text-ink-muted text-xs sm:text-sm space-y-2">
            ...
            <div className="pt-4 border-t border-line">
              <p className="text-ink-muted text-xs sm:text-sm flex items-start gap-2">
          ...
          <div className="bg-white rounded-xl sm:rounded-2xl p-5 sm:p-6 border border-line">
            ...
            <div className="space-y-4">
              <div className="p-3 bg-surface rounded-lg">
                ...
                <p className="text-ink-muted text-xs sm:text-sm mt-1">Available 24/7 for bookings</p>
              </div>
              ...
              <div className="p-3 bg-surface rounded-lg">
                ...
                <p className="text-ink-muted text-xs sm:text-sm mt-1">Response within 2 hours</p>
              </div>
              ...
              <div className="p-3 bg-surface rounded-lg">
                ...
                <p className="text-ink-muted text-xs mt-2">Office visits: Mon-Sun, 9 AM – 8 PM. Phone & WhatsApp booking: Open 24 hours, 7 days a week.</p>
              </div>
            </div>
            ...
            <div className="mt-5 pt-4 border-t border-line">
              <Link
                href="/contact"
                className="text-brand hover:text-brand transition text-xs sm:text-sm flex items-center gap-2"
              >
        ...
        <section className="text-center bg-white border border-brand rounded-2xl p-6 sm:p-8">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center">
            <Link
              href="/"
              className="bg-brand hover:bg-brand-hover text-white px-6 sm:px-8 py-3 rounded-lg font-semibold transition-all inline-flex items-center justify-center gap-2 shadow-lg shadow-md"
            >
