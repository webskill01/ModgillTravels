          ...
          <div className="space-y-6">
            ...
            <div className="bg-gradient-to-br from-cyan-500/10 to-blue-500/10 border border-cyan-500/30 rounded-xl p-4 sm:p-5">
              <p className="text-cyan-200 text-sm sm:text-base leading-relaxed">
                <strong className="text-cyan-400">Serving since 2025:</strong> ModgillTravels is Patiala&apos;s dedicated taxi service for outstation cab booking, airport transfers, and corporate travel. Over 5,000 satisfied customers across Punjab, Haryana, Delhi, and Himachal Pradesh in our first year.
              </p>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-br from-slate-800 to-slate-900 rounded-xl sm:rounded-2xl p-5 sm:p-6 border border-gray-700">
            ...
            <div className="space-y-4">
              ...
              <div className="p-3 bg-slate-700/30 rounded-lg">
                ...
                <p className="text-gray-400 text-xs mt-2">Office visits: Mon-Sun, 9 AM – 8 PM. Phone & WhatsApp booking: Open 24 hours, 7 days a week.</p>
              </div>
            </div>
