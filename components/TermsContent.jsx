    ...
    <div className="min-h-screen">
      ...
      <section className="bg-white border-b border-line">
        <div className="max-w-4xl mx-auto px-4 py-8 sm:py-10 text-center">
          <div className="w-12 h-12 sm:w-14 sm:h-14 bg-accent-soft border border-brand rounded-full flex items-center justify-center mx-auto mb-4 sm:mb-5">
            <GavelIcon className="w-6 h-6 sm:w-7 sm:h-7 text-brand" />
          </div>
      ...
      <main className="max-w-4xl mx-auto px-4 py-6 sm:py-8">
        ...
        <section className="bg-surface border border-brand rounded-xl p-5 sm:p-6 mb-8">
          <div className="flex items-start gap-3 mb-3">
            ...
            <div>
              <h2 className="text-lg sm:text-xl font-bold text-ink mb-2">Terms at a Glance</h2>
            ...
            >
              <div className="flex items-start gap-3 sm:gap-4 mb-4">
                <div className={`w-10 h-10 sm:w-12 sm:h-12 rounded-full flex items-center justify-center flex-shrink-0 ${
                  ...
                  section.color === 'green' ? 'bg-accent-soft' :
                  section.color === 'yellow' ? 'bg-accent-soft' :
                  section.color === 'purple' ? 'bg-accent-soft' : 'bg-accent-soft'
                }`}>
                  <span className={
                    section.color === 'cyan' ? 'text-brand' :
                    section.color === 'blue' ? 'text-brand' :
                    section.color === 'green' ? 'text-brand' :
                    section.color === 'yellow' ? 'text-brand' :
                    section.color === 'purple' ? 'text-brand' : 'text-brand'
                  }>
                    {section.icon}
                  </span>
                </div>
        ...
        <section className="mt-8 sm:mt-10">
          <h2 className="text-xl sm:text-2xl font-bold text-ink mb-5 text-center">Key Policies</h2>
        ...
        >
          <div className="flex items-start gap-3 sm:gap-4 mb-4">
            ...
            <div className="flex-1">
              <h3 className="text-ink font-bold text-base sm:text-lg mb-3">Questions or Disputes?</h3>
