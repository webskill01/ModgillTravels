...
//
// Every svg also carries width/height attributes. They are a size floor, not
// a style: a caller passing className="text-brand" replaces the w-5 h-5
// default, and without these attributes the icon would have no intrinsic
// size and stretch to fill its parent. Tailwind sizing classes still win,
// because CSS outranks presentation attributes.
