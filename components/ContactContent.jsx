...
const contactMethods = [
  ...
  },
  {
    ...
    value: "+91-62849-92669",
    action: "https://wa.me/916284992669?text=Hi, I need help with taxi booking",
    ...
    <div className="min-h-screen bg-gray-900">
      ...
      <div className="border-b border-slate-800">
        <div className="max-w-6xl mx-auto px-4 py-8">
          <div className="text-center">
            ...
            <p className="text-gray-400 text-sm md:text-base lg:text-lg mx-auto">
              We're here to help you 24/7. Get in touch for bookings, support,
              or any questions.
            </p>
          </div>
        </div>
      ...
      <main className="max-w-6xl mx-auto px-4 py-8">
        ...
        <section className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
          {contactMethods.map((method) => (
            <Link
              ...
              className="bg-slate-800 border border-gray-700 rounded-xl p-6 hover:border-cyan-600/30 transition-all duration-300 hover:scale-105"
            >
              <div
        ...
        <section className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          ...
          <div
            id="office-location"
            className="bg-slate-800 border border-gray-700 rounded-xl p-6"
          >
            <h3 className="text-lg font-bold text-white mb-4 flex items-center gap-2">
            ...
            <div className="space-y-3 text-sm">
              <div>
                ...
                <p className="text-white font-medium mt-1">
                  Urban Estate, Phase 2 Near Police Station
                  <br />
          ...
          <div className="bg-slate-800 border border-gray-700 rounded-xl p-6">
            ...
            <div className="space-y-3 text-sm">
              <Link
                href="/about"
                className="block text-cyan-600 hover:text-cyan-500 transition"
              >
                → About Us
              </Link>
              <Link
        ...
        <section className="bg-slate-800 border border-gray-700 rounded-xl p-6 mb-12">
          ...
          <div className="flex gap-4">
            ...
            <a
              href="#"
              className="w-13 h-13 rounded-full bg-blue-600/20 flex items-center justify-center text-blue-400 hover:bg-blue-600/30 hover:scale-110 transition-all duration-200"
              aria-label="Facebook"
            >
            ...
            <a
              href="#"
              className="w-13 h-13 rounded-full bg-pink-600/20 flex items-center justify-center text-pink-400 hover:bg-pink-600/30 hover:scale-110 transition-all duration-200"
        ...
        <section className="bg-slate-800 border border-cyan-600/20 rounded-xl p-8 text-center">
          ...
          <p className="text-gray-300 text-sm md:text-base mb-6 mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a
              href="https://wa.me/916284992669?text=Hi, I need urgent taxi booking assistance"
              target="_blank"
              rel="noopener noreferrer"
