        ...
        <div className="space-y-3">
          <div className="flex items-start gap-3">
            ...
            <div className='flex justify-center items-center'>
              <span className="text-white font-medium text-sm ">Fill the form & get instant WhatsApp confirmation</span>
            </div>
          </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              <span className="text-white font-medium text-sm">Driver will contact you before pickup</span>
            </div>
          </div>
      ...
      <div className="bg-gradient-to-br from-slate-800 to-slate-900 rounded-2xl p-4 lg:p-6">
        ...
        <div className="space-y-2 lg:space-y-3 flex flex-col md:flex-col ">
          ...
          >
            ...
            <div>
              <span className="text-white font-medium text-sm">+91-98765-43210</span>
            </div>
          </a>
          
          <a
            href="https://wa.me/919876543210?text=Hi, I need help with my booking"
            target="_blank"
